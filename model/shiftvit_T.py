...
class ShiftVitCount(nn.Module):
    def __init__(self, model_type='tiny', is_train=True):
        super().__init__()
...
if __name__ == '__main__':
    ...
    final_out = shiftvitcount(input)
    from model.up import PixelShuffleUpsampleLayer
    up = PixelShuffleUpsampleLayer(input_chans=768)
    final_out = up(final_out)
    # up_2 = PixelShuffleUpsampleLayer(input_chans=192)
    # final_out = up_2(y)
